    ...
    >
        ...
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <div className="text-white text-lg font-bold tracking-tight">
              School<span className="text-blue-400">Launch</span>
            </div>
            <div className="text-[0.6rem] text-slate-500 uppercase tracking-widest font-medium">
              Financial Planning
            </div>
          </div>
        </div>
      ...
      <div className="px-3 py-4 border-t border-white/10">
        <button
          ...
          className="w-full text-left px-3 py-2 text-sm text-slate-500 hover:text-white hover:bg-white/5 rounded-lg transition-colors"
        >
          Sign Out
        </button>
      </div>
